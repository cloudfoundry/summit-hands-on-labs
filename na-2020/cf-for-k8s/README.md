...
```
Notice that there are 2 pods in the `cf-workloads` namespace (more on namespaces in the next coming sections). The # of pods correspond to the # of instances of the app you specified above (`-i 2`).
